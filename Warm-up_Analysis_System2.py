"""
This is a code to implement warm-up analysis for system 2.
...
from Phase3_System2 import simulation
...
fig.suptitle(f'Warm-up analysis over {num_of_replications} replications - System 2')
...
fig.tight_layout()
fig.show()
fig.savefig('Insurance Center System 2 - Warm-up analysis - Time-Frame Approach')
